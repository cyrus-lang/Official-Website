...
export default function Header({ className, navigationItems }: { className?: string, navigationItems?: DocNavItem[] }) {
  ...
  return (
    <>
      <header
        className={`select-none border-b sticky top-0 z-50  bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60 header-fa ${fontFamily} ${className}`}
      >
        <div
