...
export function HeroCode({ code }: HeroCodeProps) {
  ...
  return (
    <Motion
      ...
      dir="ltr"
    >
      <div className="absolute top-0 left-0 right-0 h-16 bg-gradient-to-b from-background/95 dark:from-zinc-950/95 via-background/40 dark:via-zinc-950/40 to-transparent pointer-events-none z-10" />
