...
کوروش یک زبان برنامه‌نویسی سیستمی برای ساخت زیرساخت‌هایی است که باید برای سال‌ها اجرا شوند — زبانی که درباره هر تصمیم سطح ماشین صریح است، بدون هزینه‌های پنهان، زمان اجرا (runtime)، یا قیمومیت کامپایلر.
