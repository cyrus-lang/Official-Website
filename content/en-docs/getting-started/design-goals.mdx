...
Cyrus is a systems programming language for building infrastructure that must run for years — explicit about every machine-level decision, without hidden costs, runtime, or compiler guardianship.
...
<Table>
  ...
  <TableBody>
    ...
    <TableRow>
      <TableCell>Algebraic types with zero-cost generics (enums, structs, interfaces)</TableCell>
